...
class TestSphericalGaussFilter(TestCase):
    ...
    #     sgf.lat_lon_grid = np.array([[(-4.0, -2.0), (-4.0, 0.0), (-4.0, 2.0), (-4.0, 50.0)], [(0.0, -2.0), (0.0, 0.0), (0.0, 2.0), (0.0, 50.0)], [(4.0, -2.0), (4.0, 0.0), (4.0, 2.0), (4.0, 50.0)], [(10.0, -2.0), (10.0, 0.0), (10.0, 2.0), (10.0, 50.0)]])
    #     lat_lon_pairs = []
